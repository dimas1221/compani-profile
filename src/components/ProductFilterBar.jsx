...
//   // helper: count products in a main category
...
//       <motion.div
//         ref={carouselRef}
//         className="flex items-stretch gap-4 sm:gap-5 overflow-x-auto px-4 sm:px-6 py-4 snap-x snap-mandatory scroll-smooth
...
//         {data.map((cat) => {
//           const active = selectedMain === cat.main_category.id;
//           const IconComp = Icons[cat.main_category.icon] || Icons.Box;
//           return (
//             <FilterCard
//               key={cat.main_category.id}
//               iconComp={IconComp}
//               title={
//                 lang === "id"
//                   ? cat.main_category.name_id
//                   : cat.main_category.name_en
//               }
//               count={countProducts(cat)}
//               active={active}
//               onClick={() => onSelect(cat.main_category.id)}
//             />
//           );
//         })}
//       </motion.div>
...
//       <Icons.ChevronRight
//         className={`w-4 h-4 ${
//           active ? "text-white/80" : "text-gray-300 dark:text-gray-600"
//         }`}
//       />
//     </motion.button>
//   );
